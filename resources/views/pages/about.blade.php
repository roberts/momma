                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                            ...
                            <div class="lg:order-first lg:row-span-2">
                                ...
                                In reality, this is what happened. We received $729k in volume at this tax structure generating $74,000 in revenue. The <a class="text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://basescan.org/address/0xcdaC6E18e189fB11A8b972E6f3618143ba1075a1">community wallet</a> received $29k (8.64 ETH). There was an error in the code where the developer wallet didn't receive any of it and that percentage was sent to the <a class="text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://basescan.org/address/0xdD272064aB999A7C8e11947038047357372e266e">marketing wallet</a>, which received $45k (13.27 ETH). The marketing wallet should have received the same as the community wallet and the developer wallet was supposed to receive $16k (4.63 ETH). Both the community wallet and marketing wallet are in coops control.
                                </p><p>
                                ...
                                The rest of the expenses are for marketing and developer fees which were combined into one wallet but should have been separated for transparency in budgeting and <a class=" text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://github.com/roberts/standard/commit/ca46e3bec021b5267c121e6abe7598715d81ac7c">has already been corrected</a> in the contract for the next Drew Roberts project.
                                    </p><p>
                                ...
                                The marketing was setup to be managed by Matt but he was unavailable for launch and those decisions on launch day so we switched it right before launch <a class=" text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://basescan.org/tx/0x29a3c7b6530f2a60f1a42c18e08a7b194f5f3a58be7d38b644e3c07e88656c8b">in this transaction</a> to coops which Drew wanted because it is a community project for her.
                                </p><p>
                            ...
                            <div class="lg:pl-20">
                                <ul role="list">
                                    <li class="flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://x.com/coopscoin">
                                            ...
                                            <span class="ml-4">@coopscoin</span>
                                        </a>
                                    </li>
                                    <li class="mt-4 flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="/about#">
                                            ...
                                            <span class="ml-4">t.me/coopscoin</span>
                                        </a>
                                    </li>
                                    <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="mailto:club@coopscoin.com">
                                            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
                                            ...
                                            <span class="ml-4">club@coopscoin.com</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
