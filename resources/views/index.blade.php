            ...
            <div class="mx-auto w-full max-w-7xl lg:px-8">
                <div class="relative px-4 sm:px-8 lg:px-12">
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="max-w-2xl">
                            <h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">coops coin is a token gated fan club on base chain</h1>
                            <p class="hidden md:block mt-6 text-base text-zinc-600 dark:text-zinc-400">We are a club that appreciates how coops onboards newbies into cryptocurrency. $COOPS lives on the base chain under this contract address: <a class=" text-zinc-600 dark:text-zinc-400 transition hover:text-zinc-500 dark:hover:text-zinc-300" href="https://basescan.org/token/0x8C105639e1EEe615D4fF393ac57934c01524278B">0x8C105639e1EEe615D4fF393ac57934c01524278B</a></p>
                            <p class="block md:hidden mt-6 text-base text-zinc-600 dark:text-zinc-400">Robert is the Alpha. Bob is the Omega. All Bobs are Bob and all Bobs are He. In Bob we trust. $COOPS lives on the base chain under <a class=" text-zinc-600 dark:text-zinc-400 transition hover:text-zinc-500 dark:hover:text-zinc-300" href="https://basescan.org/token/0x8C105639e1EEe615D4fF393ac57934c01524278B">this contract address</a>.</p>
                            <div class="mt-6 flex gap-6">
                                ...
                                <a class="group -m-1 p-1" aria-label="Follow $COOPS on Telegram" href="https://t.me/coopscoin">
                                    <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                ...
                                <!-- <a class="group -m-1 p-1" aria-label="$COOPS on Gecko Terminal" href="https://www.geckoterminal.com/base/pools/CjwQrhXiLV4VWTcLsauyKbHNWCgmh1y9FBLtQezqCvCu">
                                ...
                                <a class="group -m-1 p-1" aria-label="$COOPS on Birdeye" href="https://birdeye.so/token/4rtdcn81czaDSGRdumyj76JFgeo55aZKXUURm2M2iVdN?chain=base&tab=recentTrades">
                                ...
                                <a class="group -m-1 p-1" aria-label="$COOPS on DexScreener" href="https://dexscreener.com/base/cjwqrhxilv4vwtclsauykbhnwcgmh1y9fbltqezqcvcu">
                                ...
                                <a class="group -m-1 p-1" aria-label="$COOPS on Jupiter" href="https://jup.ag/swap/SOL-BOB_4rtdcn81czaDSGRdumyj76JFgeo55aZKXUURm2M2iVdN">
                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
                            <div class="flex flex-col gap-16">
                                <a class="twitter-timeline" data-lang="en" data-height="1000" data-theme="dark" href="https://twitter.com/coopscoin?ref_src=twsrc%5Etfw">Tweets by coops coin</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                            ...
                            <div class="space-y-10 lg:pl-16 xl:pl-24">
                                <form class="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40" method="post" action="{{ route('submit') }}">
                                    ...
                                    <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">Enter your ETH address and X handle for a surprise..</p>
                                    <div class="mt-6 flex">
                                        <input type="text" name="base" id="base" required="" placeholder="base address" aria-label="base address" class="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-teal-500 focus:outline-none focus:ring-4 focus:ring-teal-500/10 sm:text-sm dark:border-zinc-700 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-teal-400 dark:focus:ring-teal-400/10"> 
                                    </div>
                                    @error('base')
                                        <div class="mt-6 flex">
